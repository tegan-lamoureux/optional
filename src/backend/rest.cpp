...
std::string Optional::Rest::post(std::string post_url, std::string header, std::string post_data, bool& valid_data_out, bool verbose) {
...
std::string Optional::Rest::get(std::string get_url, std::string header, bool& valid_data_out, bool verbose) {
    valid_data_out = false;
